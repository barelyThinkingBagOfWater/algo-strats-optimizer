...
public final class MovingAveragesStrategy implements AnalyzableStrategy {
    ...
    @Analyzable(stringValues = {"EMA", "DoubleEMA", "TripleEMA", "HMA", "KAMA", "LWMA", "MMA", "ZLEMA", "SMA"})
    private final String movingAverageType;
    ...
    public Strategy buildStrategy(BarSeries series) {
        ...
        switch (movingAverageType) {
            ...
            default -> throw new IllegalArgumentException("Moving average type not yet implemented: " + movingAverageType);
        }
